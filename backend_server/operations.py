...
REDIS_PORT = 6379
LOG_CLICKS_TASK_QUEUE_URL = 'amqp://oqkdlqtj:RlbqZ1lWTFn71nCye558KSLMEoP0G_N2@donkey.rmq.cloudamqp.com/oqkdlqtj'
...
def get_one_news():
    """Get one news"""
    db = mongodb_client.get_db()    # pylint: disable=invalid-name
